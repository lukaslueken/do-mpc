...
for k in range(20):
    ...
    z_num, where_cons_active = nlp_diff.extract_active_primal_dual_solution(nlp_sol_red, method_active_set="primal", tol=1e-6)
    param_sens, residues = nlp_diff.calculate_sensitivities(z_num, p_num, where_cons_active, lin_solver="scipy", check_rank=True, track_residues=True, lstsq_fallback=True)
